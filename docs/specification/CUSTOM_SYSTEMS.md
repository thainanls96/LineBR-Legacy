...
**Propósito de design:** tornar o Hero **visível** — reforça [P-07](../constitution/DESIGN_PRINCIPLES.md) (*todo Hero deve ser admirado*) sem conferir nenhum poder.
...
Lista completa e permanente: [monetization/FORBIDDEN_FEATURES.md](../constitution/FORBIDDEN_FEATURES.md).
