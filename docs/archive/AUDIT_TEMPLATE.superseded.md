...
> Duplicado: superado por `knowledge/baseline/SYSTEM_TEMPLATE.md` (superset, 12 seções).
...
> Ao iniciar: marque o sistema como 🔵 *Em auditoria* no [SYSTEM_INDEX.md](../knowledge/baseline/SYSTEM_CATALOG.md). Ao terminar: 🟡 *Auditado*.
...
- [ ] [SYSTEM_INDEX.md](../knowledge/baseline/SYSTEM_CATALOG.md) atualizado
