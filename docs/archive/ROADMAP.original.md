...
> Superado pelo `ROADMAP.md` definitivo (Sprint 010).
...
- [x] Compilar gameserver + loginserver (2.343 `.java`, 0 warnings/erros) + datapack. Ver [BUILD_VALIDATION.md](../engineering/BUILD_VALIDATION.md).
- [x] Servidor sobe (login + game) contra MariaDB local — Sprint 002, 0 erros. Ver [RUNTIME_VALIDATION.md](../engineering/RUNTIME_VALIDATION.md) e [ENVIRONMENT_SETUP.md](../engineering/ENVIRONMENT_SETUP.md).
...
- [x] Diferenças documentadas em [BUILD_VALIDATION.md](../engineering/BUILD_VALIDATION.md) (esperadas: fornecedor do JDK; nenhuma inesperada).
