...
Retail First operacional: sem evidência ≥ ★★★★, não muda ([EVIDENCE_LEVELS](../retail-knowledge-base/EVIDENCE_LEVELS.md)).
...
> Toda resolução de conflito vira entrada no [DECISION_LOG](DECISION_LOG.md).
