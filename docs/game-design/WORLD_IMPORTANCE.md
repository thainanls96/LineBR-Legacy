...
> **Princípio regente:** [P-02](DESIGN_PRINCIPLES.md) — *todo mapa deve importar*. Região morta = sintoma de erro nosso (rates/economia), não do mapa.
...
| **Nota técnica** | ⚠️ **não são um "sistema" na aCis** — vivem no datapack + `SevenSignsManager` + `DungeonGatekeeper`/`DungeonTeleporter` ([SYSTEM_CATALOG F06](../retail-baseline/SYSTEM_CATALOG.md)) |
...
**Por que ir:** deslocamento; imersão · **Risco:** se teleporte for barato demais, o boat (e o mundo) somem → fere [P-10](DESIGN_PRINCIPLES.md).
...
## Riscos declarados
- 🔴 **Teleporte barato encolhe o mundo** — o custo de deslocamento é o que dá **tamanho** ao mundo ([P-10](DESIGN_PRINCIPLES.md)).
