...
> **Nenhuma implementação** em nenhuma fase — a Baseline é documental. Implementação só depois, sistema a sistema, pela [CHANGE_ACCEPTANCE_POLICY](../methodology/CHANGE_ACCEPTANCE_POLICY.md).
