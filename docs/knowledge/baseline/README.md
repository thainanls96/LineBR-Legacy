...
A Baseline **consome** a metodologia: usa a escala ★ de [EVIDENCE_LEVELS](../methodology/EVIDENCE_LEVELS.md), as fontes de [RESEARCH_SOURCES](../methodology/RESEARCH_SOURCES.md) e é filtrada pela [CHANGE_ACCEPTANCE_POLICY](../methodology/CHANGE_ACCEPTANCE_POLICY.md).
