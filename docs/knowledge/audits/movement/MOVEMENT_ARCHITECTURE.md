...
> ⚠️ **Estado atual do LineBR:** o runtime preservado roda **sem arquivos de geodata** (lista de regiões removida) → `findPath` indisponível na prática; movimento cai no comportamento sem pathfinding. Ver [ENVIRONMENT_SETUP.md](../../../engineering/ENVIRONMENT_SETUP.md).
