...
**Fato:** `geoengine.properties` → `GeoDataType = L2OFF`; a aCis lê o **formato de geodata do L2OFF**. Porém o runtime preservado do LineBR **não possui os arquivos** (lista de 139 regiões removida — ver [ENVIRONMENT_SETUP.md](../../../engineering/ENVIRONMENT_SETUP.md)).
