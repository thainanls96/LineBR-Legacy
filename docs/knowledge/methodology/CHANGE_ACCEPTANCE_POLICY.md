...
❌ Reprova: qualquer coisa que altere economia/progressão/poder sem base retail. Pay-to-Win é vetado pelo [Manifesto](../../constitution/LINEBR_MANIFESTO.md).

### ✔ 4. Possui rollback
Commit atômico revertível (`git revert`), preferencialmente aditivo/configurável. A [Base Zero](../../constitution/BASE_ZERO.md) e as tags permanecem intactas.
...
- changelog + atualização do [SYSTEM_INDEX.md](../baseline/SYSTEM_CATALOG.md).
