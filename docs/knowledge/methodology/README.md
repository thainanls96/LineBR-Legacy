...
Complementa (não substitui) o [PROJECT_PHILOSOPHY.md](../../constitution/PROJECT_PHILOSOPHY.md), o [LINEBR_MANIFESTO.md](../../constitution/LINEBR_MANIFESTO.md) e o [ADR-003 — Retail First](../../adr/ADR-003-retail-first.md).
...
| [SYSTEM_INDEX.md](../baseline/SYSTEM_CATALOG.md) | Todos os sistemas do servidor e seu status de auditoria. |
| [AUDIT_TEMPLATE.md](../baseline/SYSTEM_TEMPLATE.md) | Template obrigatório de toda auditoria futura. |

## Como usar (fluxo rápido)

1. Vai auditar um sistema? → copie o [AUDIT_TEMPLATE.md](../baseline/SYSTEM_TEMPLATE.md) e atualize o [SYSTEM_INDEX.md](../baseline/SYSTEM_CATALOG.md) para *Em auditoria*.
