...
**Consequência formal:** nenhum sistema pode ser marcado 🔵 *Retail validado*, e **nenhuma alteração de gameplay está autorizada** pela [CHANGE_ACCEPTANCE_POLICY](../retail-knowledge-base/CHANGE_ACCEPTANCE_POLICY.md). Sanar isso é o trabalho nº 1 do projeto — ver [ROADMAP_BASELINE.md](ROADMAP_BASELINE.md) Fase 00.
...
| **Sistemas** | todos |
| **Observações** | Prova o que a aCis **faz**. **Não é evidência retail** — nem quando o autor comenta "retail like" (isso é intenção, não prova). Ver [EVIDENCE_LEVELS](../retail-knowledge-base/EVIDENCE_LEVELS.md). |
...
| **Nível** | ★★★★★ **sobre a aCis** · ☆ **sobre o retail** |
| **Sistemas** | todos |
| **Observações** | Provado equivalente a EV-001: **2.881/2.881 classes byte-idênticas** ao build da source (só o `MANIFEST.MF` difere). Ver [BUILD_VALIDATION](../BUILD_VALIDATION.md). |
...
| **Observações** | 14 divergências suspeitas levantadas ([MOVEMENT_L2OFF_DIFFERENCES](../retail-audit/MOVEMENT_L2OFF_DIFFERENCES.md)). **Nenhuma** atinge ★★★★ como afirmação sobre o retail. |
...
> **Lição registrada:** fontes de comunidade **morrem**. Por isso a [regra de arquivamento](../retail-knowledge-base/RESEARCH_SOURCES.md#regra-de-arquivamento-obrigatória) (Wayback + hash + data) é obrigatória **no momento da citação**.
