...
- ❌ Nunca: vantagem comprável em siege ([P-11](../constitution/DESIGN_PRINCIPLES.md)).
...
- **Escassez** ([P-07](../constitution/DESIGN_PRINCIPLES.md)): poucos, cíclicos, visíveis.
...
- **Nomes memoráveis** → reputação persistente (por isso troca de nome é problemática — [MONETIZATION §3.2](../monetization/MONETIZATION_PHILOSOPHY.md));
...
| Wipes | história e vínculo ([P-13](../constitution/DESIGN_PRINCIPLES.md)) |
...
**Nossa posição:** a resposta para população baixa **não pode ser** quebrar o design ([P-11](../constitution/DESIGN_PRINCIPLES.md), [ADR-003](../adr/ADR-003-retail-first.md)). Tem que ser comunidade, divulgação e paciência — ou o projeto assume conscientemente que será pequeno ([D-003](DECISION_LOG.md)).
