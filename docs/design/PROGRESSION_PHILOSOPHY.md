...
- **Perda de XP na morte:** é o que faz o risco existir ([P-14](../constitution/DESIGN_PRINCIPLES.md)). Remover = remover a tensão do jogo inteiro.
...
- **Tensão fundamental:** drop generoso = economia inflada + regiões desertas ([P-02](../constitution/DESIGN_PRINCIPLES.md), [P-04](../constitution/DESIGN_PRINCIPLES.md)).
...
- **Regra de ouro:** materiais relevantes devem vir **preferencialmente** de spoil. Se drop normal ou loja fornecerem o mesmo, o Dwarf morre e a economia perde o seu banco central ([P-05](../constitution/DESIGN_PRINCIPLES.md)).
...
- **Emoção:** medo + cobiça ([GAME_PHILOSOPHY §3](../constitution/GAME_PHILOSOPHY.md)). Enchant sem risco é só um botão.
...
- **Por que preservar a escassez:** boss trivial = item trivial = economia trivial ([P-03](../constitution/DESIGN_PRINCIPLES.md)).
...
- **Ameaça:** qualquer vantagem comprável aqui destrói o sistema inteiro ([P-11](../constitution/DESIGN_PRINCIPLES.md)).

## Hero
- **Papel:** o **topo visível** do servidor. Status social encarnado (aura, skills, canal).
- **Regra:** escassez absoluta ([P-07](../constitution/DESIGN_PRINCIPLES.md)). Hero é o que o jogador de level 20 vê passar em Giran e pensa "um dia".
