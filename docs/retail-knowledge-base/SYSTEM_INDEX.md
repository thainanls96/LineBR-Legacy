...
> **Nota:** *Auditado* → *Retail validado* exige uma **fonte retail de nível ★★★★+**, que o projeto ainda **não possui** (ver [RESEARCH_SOURCES.md](RESEARCH_SOURCES.md#estado-atual-das-fontes-2026-07-15)). Hoje, nenhum sistema pode passar de 🟡.
...
> Ordem final é decisão do dono. Toda auditoria usa o [AUDIT_TEMPLATE.md](AUDIT_TEMPLATE.md).
