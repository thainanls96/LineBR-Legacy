...
> Consequência: **nenhum** dos 14 itens de [MOVEMENT_L2OFF_DIFFERENCES](../retail-audit/MOVEMENT_L2OFF_DIFFERENCES.md) atinge hoje ★★★★☆ **como afirmação sobre o retail**. Por isso o backlog daquele sistema começa por *obter evidência* (geodata + referência medível), não por implementar.
