...
| **Runtime local** | ambiente validado na Sprint 002 ([ENVIRONMENT_SETUP.md](../ENVIRONMENT_SETUP.md)) |
...
```
**Critério:** `BUILD SUCCESSFUL`, **0 erros**. Warnings novos devem ser justificados. Ver [BUILD_VALIDATION.md](../BUILD_VALIDATION.md).
...
5. Encerrar
```
Baseline de referência (Sprint 002): login+game sobem com **0 ERROR / 0 WARN**. Ver [RUNTIME_VALIDATION.md](../RUNTIME_VALIDATION.md).
