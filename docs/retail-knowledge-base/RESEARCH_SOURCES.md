...
> Ou seja: **o projeto ainda não possui nenhuma fonte retail de nível ★★★★+ instalada.** Sanar isso é pré-requisito para qualquer "retail fix" — ver [SYSTEM_INDEX.md](SYSTEM_INDEX.md) e o backlog de Movement.
