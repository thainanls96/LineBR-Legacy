...
### 8. Build
`JDK 21 + Apache Ant` — **0 erros**. Ver [Build.md](../Build.md) e [BUILD_VALIDATION.md](../BUILD_VALIDATION.md).

### 9. Runtime Validation
Servidor sobe (login + game) e o **cenário específico** da mudança é exercitado. Ver [VALIDATION_PROCESS.md](VALIDATION_PROCESS.md) e [RUNTIME_VALIDATION.md](../RUNTIME_VALIDATION.md).
